...
- `[lf-field-container]`, `[lf-field-adhoc-container]`, `[lf-field-template-container]`: Fixed a Number field with a min/max constraint clearing the entered value while typing, which could prevent the field from ever becoming valid even after correcting the input.
- `[lf-field-container]`, `[lf-field-adhoc-container]`, `[lf-field-template-container]`: Fixed numeric field validation treating `0` as an empty value and skipping constraint checks.
