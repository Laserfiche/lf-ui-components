...
import { FieldFormat, ValidationRule, ValidationUtils } from '@laserfiche/laserfiche-ui-components/shared';
...
export class TimeFieldComponent extends BaseFieldDirective {
  ...
  private readonly TIME_FIELDS_MUST_BE_IN_THE_FORMAT_0 = this.localizationService.getStringWithObservableParams('FIELD_NOT_TIME', [this.LOCALE_TIME]);
